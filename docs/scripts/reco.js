...
const AIRTABLE_BASE_ID = 'your_airtable_base_id_here'; // Replace with actual value
const AIRTABLE_API_KEY = 'your_airtable_api_key_here'; // Replace with actual value
const AIRTABLE_TABLE_NAME = 'your_airtable_table_name_here'; // Replace with actual value
